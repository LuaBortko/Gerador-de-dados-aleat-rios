...
##depart = {"id": None, "nome": None, "ra_coordenador": None}
...
def resetarDB():
    cursor.execute('alter table departamento DROP constraint ra ' \
    'drop table if exists historico;' \
    'drop table if exists matriz_curricular;' \
    'drop table if exists tcc_aluno;' \
...
try:
    ...
    professores = gerarProfessor(10*n)
